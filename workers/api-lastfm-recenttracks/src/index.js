export default {
    async fetch(request, env, ctx) {
        ...
        const apiUrl = `https://ws.audioscrobbler.com/2.0/?method=user.getrecenttracks&user=${encodeURIComponent(username)}&api_key=${encodeURIComponent(apiKey)}&from=${oneWeekAgo}&limit=3&format=json`;
        ...
        try {
            ...
            // Commented out to skip computing unique artists and albums
            /*
