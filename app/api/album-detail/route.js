// ABOUTME: API route that proxies album detail requests to Cloudflare Worker
...
export async function GET(request) {
  ...
  try {
    const workerUrl = `https://api-perplexity-albumdetail.rian-db8.workers.dev?album=${encodeURIComponent(
      album
    ...
    console.error('Error proxying to album detail worker:', error);
